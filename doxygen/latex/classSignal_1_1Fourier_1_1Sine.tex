...
45             \textcolor{comment}{//use LUT}
46             signal = \hyperlink{namespaceSignal_1_1Fourier_ab1bf3cdef768a49cf3e927b9daf7da9d}{sine}((\hyperlink{classSignal_1_1SignalGenerator_a43b0eec84ee7df04c947533c0511c2c0}{\_pstep}() + \hyperlink{classSignal_1_1SignalGenerator_a6b4444d46747c8517171edbbf4b5588f}{\_phase\_offset}));
47 \textcolor{preprocessor}{#elif SINE\_IMPL==SINE\_USE\_TAYLOR}
48             \textcolor{comment}{//use custom taylor series function}
49             signal = \hyperlink{namespaceBackend_1_1Taylor_afda165e6dde636dd0f7b32031a71c7df}{Backend::Taylor::Sine}((\hyperlink{classSignal_1_1SignalGenerator_a43b0eec84ee7df04c947533c0511c2c0}{\_pstep}()+
...
51             \textcolor{comment}{//use built int math.h sin();}
52             signal = sin((\hyperlink{classSignal_1_1SignalGenerator_a43b0eec84ee7df04c947533c0511c2c0}{\_pstep}()+\hyperlink{classSignal_1_1SignalGenerator_a6b4444d46747c8517171edbbf4b5588f}{\_phase\_offset})*\hyperlink{PI_8h_a4912c64aec0c943b7985db6cb61ff83a}{TWOPI});
...
Definition at line 57 of file Sine.\+h.


\begin{DoxyCode}
57                                                    \{
58             signal.Flush();
59             \textcolor{keywordflow}{while} (!signal.Full()) \{
60                 \textcolor{keywordflow}{if} (\hyperlink{classSignal_1_1Fourier_1_1Sine_aa35c77904f8d7a0de6fa4895d6c53644}{Perform}(\hyperlink{classSignal_1_1Fourier_1_1FourierGenerator_ad720bf2b268dc621ace64c54c0816597}{\_sample})) \{
61                     \textcolor{keywordflow}{if}(signal.Write(\hyperlink{classSignal_1_1Fourier_1_1FourierGenerator_ad720bf2b268dc621ace64c54c0816597}{\_sample}))\{
62                     \}\textcolor{keywordflow}{else} \textcolor{keywordflow}{return} \textcolor{keyword}{false};
63                 \}\textcolor{keywordflow}{else} \textcolor{keywordflow}{return} \textcolor{keyword}{false};
