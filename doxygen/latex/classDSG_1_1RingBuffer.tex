...
Definition at line 11 of file Ring\+Buffer.\+cpp.


\begin{DoxyCode}
11                                            :\hyperlink{classDSG_1_1Buffer_aa764dd8c389dcff51de08cb81fafeb86}{Buffer}(\hyperlink{classDSG_1_1RingBuffer_aaf481e139011e91b111cc048e726cafb}{make\_pow\_2}(size)),
...
12     \hyperlink{classDSG_1_1RingBuffer_a2fba2ff6ee3886101f0f58b0fd7f3641}{MASK} = this->\hyperlink{classDSG_1_1Buffer_a4e2fef9ed617af2554b25c999def8f71}{\_size}-1;
13 \}
\end{DoxyCode}
...
\begin{DoxyCode}
14                                             :\hyperlink{classDSG_1_1Buffer_aa764dd8c389dcff51de08cb81fafeb86}{Buffer}(buffer)\{
15     \hyperlink{classDSG_1_1RingBuffer_a78bd7704fd059b745bc82421e1062123}{\_write}.store(buffer.\_write.load(std::memory\_order\_acquire));
16     \hyperlink{classDSG_1_1RingBuffer_aa71bb75a5d24700be795a30e1a135a54}{\_read}.store(buffer.\_read.load(std::memory\_order\_acquire));
17     \hyperlink{classDSG_1_1RingBuffer_af6d0e1658a1f1aa298218b890e458f2f}{\_count} = buffer.\_count;
18     \hyperlink{classDSG_1_1RingBuffer_a2fba2ff6ee3886101f0f58b0fd7f3641}{MASK} = buffer.\_size-1;
19 \}
\end{DoxyCode}
...
Definition at line 28 of file Ring\+Buffer.\+cpp.


\begin{DoxyCode}
28 \{\hyperlink{classDSG_1_1RingBuffer_ab23c8003d2857809a816068eeb209d60}{Flush}();\}
\end{DoxyCode}
...
\begin{DoxyCode}
77                                                    \{
78             \textcolor{keywordflow}{return} \hyperlink{classDSG_1_1RingBuffer_af6d0e1658a1f1aa298218b890e458f2f}{\_count};
79         \}
\end{DoxyCode}
...
\begin{DoxyCode}
51                                           \{
52             \textcolor{keywordflow}{return} \hyperlink{classDSG_1_1RingBuffer_af6d0e1658a1f1aa298218b890e458f2f}{\_count}==0;
53         \}
\end{DoxyCode}
...
\begin{DoxyCode}
54                                      \{
55             \hyperlink{classDSG_1_1RingBuffer_a78bd7704fd059b745bc82421e1062123}{\_write}.store(0,std::memory\_order\_relaxed);
56             \hyperlink{classDSG_1_1RingBuffer_aa71bb75a5d24700be795a30e1a135a54}{\_read}.store(0,std::memory\_order\_relaxed);
57             \hyperlink{classDSG_1_1RingBuffer_af6d0e1658a1f1aa298218b890e458f2f}{\_count}=0;
58         \}
\end{DoxyCode}
...
\begin{DoxyCode}
48                                          \{
49             \textcolor{keywordflow}{return} \hyperlink{classDSG_1_1RingBuffer_af6d0e1658a1f1aa298218b890e458f2f}{\_count}==this->\hyperlink{classDSG_1_1Buffer_a4e2fef9ed617af2554b25c999def8f71}{\_size};
50         \}
\end{DoxyCode}
...
\begin{DoxyCode}
82                                                          \{
83             \textcolor{keywordflow}{return} pow(2, ceil(log(number)/log(2)));
84         \}
\end{DoxyCode}
...
Definition at line 81 of file Ring\+Buffer.\+h.


\begin{DoxyCode}
81 \{\textcolor{keywordflow}{return} (current+1) & \hyperlink{classDSG_1_1RingBuffer_a2fba2ff6ee3886101f0f58b0fd7f3641}{MASK};\}
\end{DoxyCode}
...
\begin{DoxyCode}
20                                                            \{
21     \hyperlink{classDSG_1_1Buffer_a977d572a7d402ff6bf991d7c5c0cc6a7}{Buffer::operator=}(buffer);
22     \hyperlink{classDSG_1_1RingBuffer_a78bd7704fd059b745bc82421e1062123}{\_write}.store(buffer.\_write.load(std::memory\_order\_acquire));
23     \hyperlink{classDSG_1_1RingBuffer_aa71bb75a5d24700be795a30e1a135a54}{\_read}.store(buffer.\_read.load(std::memory\_order\_acquire));
24     \hyperlink{classDSG_1_1RingBuffer_af6d0e1658a1f1aa298218b890e458f2f}{\_count} = buffer.\_count;
25     \hyperlink{classDSG_1_1RingBuffer_a2fba2ff6ee3886101f0f58b0fd7f3641}{MASK} = buffer.\_size-1;
...
\begin{DoxyCode}
68                                                 \{
69             \textcolor{keywordflow}{if} (!\hyperlink{classDSG_1_1RingBuffer_ac1346f5842d08b988a5297abe4089b96}{Empty}()) \{
70                 \hyperlink{classDSG_1_1RingBuffer_a34bc659c286c8913e318c0e8c0777204}{read} = \hyperlink{classDSG_1_1RingBuffer_aa71bb75a5d24700be795a30e1a135a54}{\_read}.load(std::memory\_order\_acquire);
71                 \hyperlink{classDSG_1_1RingBuffer_aa71bb75a5d24700be795a30e1a135a54}{\_read}.store(\hyperlink{classDSG_1_1RingBuffer_a6d7a76a4c9b38ccde46344662e08c9e5}{next}(\hyperlink{classDSG_1_1RingBuffer_a34bc659c286c8913e318c0e8c0777204}{read}),std::memory\_order\_release);
72                 elem = this->\hyperlink{classDSG_1_1Buffer_a6506d4763401650acb463cb5d4913e31}{\_buffer}[\hyperlink{classDSG_1_1RingBuffer_a34bc659c286c8913e318c0e8c0777204}{read}];
73                 --\hyperlink{classDSG_1_1RingBuffer_af6d0e1658a1f1aa298218b890e458f2f}{\_count};
...
\begin{DoxyCode}
59                                                        \{
60             \textcolor{keywordflow}{if} (!\hyperlink{classDSG_1_1RingBuffer_a53ddb04ffcbb5470a8d2b0a3c65b70cb}{Full}()) \{
61                 \hyperlink{classDSG_1_1RingBuffer_a703434b6afb87f1f9a05750278a822e3}{write} = \hyperlink{classDSG_1_1RingBuffer_a78bd7704fd059b745bc82421e1062123}{\_write}.load(std::memory\_order\_acquire);
62                 \hyperlink{classDSG_1_1RingBuffer_a78bd7704fd059b745bc82421e1062123}{\_write}.store(\hyperlink{classDSG_1_1RingBuffer_a6d7a76a4c9b38ccde46344662e08c9e5}{next}(\hyperlink{classDSG_1_1RingBuffer_a703434b6afb87f1f9a05750278a822e3}{write}),std::memory\_order\_release);
63                 this->\hyperlink{classDSG_1_1Buffer_a6506d4763401650acb463cb5d4913e31}{\_buffer}[\hyperlink{classDSG_1_1RingBuffer_a703434b6afb87f1f9a05750278a822e3}{write}] = elem;
64                 ++\hyperlink{classDSG_1_1RingBuffer_af6d0e1658a1f1aa298218b890e458f2f}{\_count};
